...
namespace ScrewMachineManagementSystem
{
    public class S7NetPlus
    {
        ...
        /// <summary>
        /// 上位机启动信号（DB43.DBX256.2）
        /// </summary>
        public static bool boolStartSingle = false;

        /// <summary>
        /// 当前码任务结束，T结束,300.7
        /// 1.在打螺丝之前读取到true，直接从头等待允许启动信号，结果不用上传，
        /// 2打螺丝的过程中出现true，直接从头等待允许信号，结果不用上传。
        /// 3.打螺丝结果OK /NG 后 出现TRUE，结果直接上传。从头等待启动允许信号。
        /// </summary>
        public static bool boolworkIsOver = false;
        ...
        private PLC_Point getPoinStruct(int db, int address, byte bitAddress, string remark)
        {
            PLC_Point pLC_Point = new PLC_Point();
            pLC_Point.DataBlock = db;
            pLC_Point.Address = address;
            pLC_Point.BitAddr = bitAddress;
            pLC_Point.Remark = remark;
            return pLC_Point;
        ...
        /// 初始化，28.7.0
        /// </summary>
        public static PLC_Point PLC_Init_bool = new PLC_Point() { DataBlock = 28, Address = 7, BitAddr = 0, Remark = "初始化" };

        /// <summary>
        /// 上位机启动信号8, 260, false, 0
        /// </summary>
        public static PLC_Point PC_StartSingle_Bool = new PLC_Point() { DataBlock = 8, Address = 260, BitAddr = 0, Remark = "上位机启动信号" };

        /*
        DB43.dbx300.7为 true 时 ， 开始读取螺丝数据。
        开始读取丹尼克尔电批螺丝扭矩信息
        1.在打螺丝之前读取到true，直接从头等待允许启动信号，结果不用上传，
        2打螺丝的过程中出现true，直接从头等待允许信号，结果不用上传。
        3.打螺丝结果OK /NG 后 出现TRUE，结果直接上传。从头等待启动允许信号。
        */
        ...
        /// 取消信号43, 300, 7,
        /// </summary>
        public static PLC_Point CancelSingle_Bool = new PLC_Point() { DataBlock = 43, Address = 300, BitAddr = 7, Remark = "取消信号" };

        
        /// <summary>
        /// 双工位db12.dbw64原位,DB12.64.0
        /// </summary>
        public static PLC_Point HomeStaus_Bool = new PLC_Point() { DataBlock = 1, Address = 0, BitAddr = 4, Remark = "双工位原位" };

        /// <summary>
        /// 不扫码加工，T不扫码
        /// </summary>
        public static bool boolScanCode =false;
        /// <summary>
        /// 是否扫码加工，43, 300, 0,T不扫码
        /// </summary>
        public static PLC_Point ScanCode_Bool= new PLC_Point() { DataBlock = 43, Address = 300, BitAddr = 0, Remark = "是否扫码加工" };

        /// <summary>
        /// 弹扫码窗标志 DB43.300.2,T弹窗
        /// </summary>
        public static PLC_Point OpenScanForm_Bool = new PLC_Point() { DataBlock = 43, Address = 300, BitAddr = 2, Remark = "弹扫码窗标志" };
        /// <summary>
        /// 未加工NG，43, 300, 5
        /// </summary>
        public static PLC_Point UnProcessedNG_Bool = new PLC_Point() { DataBlock = 43, Address = 300, BitAddr = 5, Remark = "未加工NG" };
        /// <summary>
        /// 当前工位sn码,DB26.DBX272.0
        /// </summary>
        public static PLC_Point CurrentSNCode_String = new PLC_Point() { DataBlock = 26, Address = 272, BitAddr = 0, Remark = "当前工位sn码" };

        /// <summary>
        /// 允许启动信号
        /// </summary>
        public static bool boolAllowStartSingle = false;
        /// <summary>
        /// 允许启动信号,DB1.DBX9.5
        /// </summary>
        public static PLC_Point PLC_AllowStartSingle_Bool = new PLC_Point() { DataBlock = 1, Address = 7, BitAddr = 5, Remark = "允许启动信号" };
        /// <summary>
        /// 工作模式，1自动
        /// </summary>
        public static bool boolWorkMode = false;
        /// <summary>
        /// 手自动模式，1, 0, 4，T自动
        /// </summary>
        public static PLC_Point PLC_WorkMode_Bool = new PLC_Point() { DataBlock = 1, Address = 0, BitAddr = 4, Remark = "手自动模式" };
        /// <summary>
        /// 是否互锁模式，离线置1，互锁置0,手动模式允许修改
        /// </summary>
        public static PLC_Point PLC_DSVLock_Bool =new PLC_Point() { DataBlock = 43, Address = 300, BitAddr = 0, Remark = "是否互锁" };

        /// <summary>
        /// 系统初始化按钮,28.7.0=1,按下1，弹起0
        /// </summary>
        public static PLC_Point PLC_System_Init_Bool = new PLC_Point() { DataBlock = 28, Address = 7, BitAddr = 0, Remark = "系统初始化按钮" };

        /// <summary>
        /// 加工产品ID不符，DB4。517.3，T错误
        /// </summary>
        public static PLC_Point PLC_ProductID_Error_Bool = new PLC_Point() { DataBlock = 28, Address = 7, BitAddr = 0, Remark = "加工产品ID不符失败" };
        
        public static bool boolSNCode_Lenght_Error=false;
        /// <summary>
        /// 读取sn码位数错误 （DB4.DBX517.7)	，T错误
        /// </summary>
        public static PLC_Point PLC_SNCode_Lenght_Error_Bool = new PLC_Point() { DataBlock = 28, Address = 7, BitAddr = 0, Remark = "读取sn码位数错误失败" };
        ...
        public static Model.ResultJsonInfo ReadOneBool(PLC_Point point)
        {
            Model.ResultJsonInfo jr = new Model.ResultJsonInfo();
            try
            {
                jr.Successed = true;
                jr.booValue = new bool[1];
                jr.booValue[0] = (bool)S71200.Read(S7.Net.DataType.DataBlock, point.DataBlock, point.Address, VarType.Bit, 1, point.BitAddr);
                return jr;
            }
            catch (Exception ex)
            {
                jr.Successed = false;
                jr.Message = string.Format("读取{0}失败,DB{1}_{2}.{3},{4}", point.Remark, point.DataBlock, point.Address, point.BitAddr, ex.Message);
                return jr;
            }
        }
        /// <summary>
        /// 读连续多个bool地址
        /// </summary>
        /// <param name="DbNum">DB</param>
        /// <param name="Start_Address">起始</param>
        /// <param name="bitAddr"></param>
        /// <returns></returns>
        public static Model.ResultJsonInfo ReadMultipleBool(int DbNum, int Start_Address, int count = 1)
        {
            ...
            {
                jr.Successed = true;
                jr.booValue = new bool[4];
                byte[] ss = S71200.ReadBytes(S7.Net.DataType.DataBlock, DbNum, Start_Address, count);
                jr.booValue = Array.ConvertAll(ss, p => p == 1);
                return jr;
            }
            catch (Exception ex)
            {
        ...
        public static Model.ResultJsonInfo ReadOneInt(PLC_Point point)
        {
            ...
            {
                jr.Successed = true;
                jr.intValue = Convert.ToInt32(S71200.Read(S7.Net.DataType.DataBlock, point.DataBlock, point.Address, VarType.Int, 1, point.BitAddr));
                return jr;
            }
            catch (Exception ex)
            {
        ...
        public static Model.ResultJsonInfo ReadOneString(PLC_Point point)
        {
            ...
            {
                //获取字符串长度
                var reservedLength = Convert.ToByte(S71200.Read(S7.Net.DataType.DataBlock, point.DataBlock, point.Address, VarType.Byte, 1, point.BitAddr));
                string StrReplac = Convert.ToString(S71200.Read(S7.Net.DataType.DataBlock, point.DataBlock, point.Address, VarType.S7String, reservedLength, point.BitAddr));
                //去除字符串后面空白符号
                if (StrReplac != null)
                {
                    int jindex = StrReplac.IndexOf('\0', 0);
        ...
        public static Model.ResultJsonInfo WriteDataBool(PLC_Point point, bool value)
        {
            Model.ResultJsonInfo jr = new Model.ResultJsonInfo();
            try
            {
                jr.Successed = true;
                S71200.WriteBit(S7.Net.DataType.DataBlock, point.DataBlock, point.Address, point.BitAddr, value);
                return jr;
            }
            catch (Exception ex)
            {
                jr.Successed = false;
                jr.Message = String.Format("{0}{1}失败,DB{2}_{3}.{4},", point.Remark, value, point.DataBlock, point.Address, point.BitAddr) + ex.Message;
                return jr;
            }
        }
        /// <summary>
